...
import { SnotifyPosition, SnotifyService, SnotifyToastConfig } from "../../node_modules/ng-snotify";
...
export class AlertsService {
  ...
  socket:SocketIOClient.Socket;
    user:any={}
  constructor(public sessionService:SessionService,private snotifyService: SnotifyService,public uS:UsersService,public rS:RecosService){
    ...
    this.socket.on('connect',() =>{
        this.sessionService.isLogged().subscribe(user=>{
            ...
            this.socket.on(`${this.user._id}`,(data) => {
                switch (data.type){
                    case "follow":this.title="New follower!";break;
                    case "like":this.title="New like!";break;
                    case "reply":this.title="New reply!";break;
                }
                this.onSuccess()
                this.uS.getUser(this.sessionService.user._id).subscribe(user=>this.uS.usersChange.emit(user))
